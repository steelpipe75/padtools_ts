...
rm ./tests/cli/E2E/output/sample_input_font_size_20.svg.txt
rm ./tests/cli/E2E/output/sample_input_list_render_type_TerminalOffset.svg.txt
...
cp ./tests/cli/E2E/temp/sample_input_font_size_20.svg ./tests/cli/E2E/output/sample_input_font_size_20.svg.txt
cp ./tests/cli/E2E/temp/sample_input_list_render_type_TerminalOffset.svg ./tests/cli/E2E/output/sample_input_list_render_type_TerminalOffset.svg.txt
