...
-   [@hono/zod-openapi](https://github.com/honojs/middleware/tree/main/packages/zod-openapi): Zodスキーマに基づく入力バリデーションとOpenAPI仕様の生成に使用。 (MIT License)
...
-   [glob](https://github.com/isaacs/node-glob): ファイルパターンの検索に使用。 (ISC License)
